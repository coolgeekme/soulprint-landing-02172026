                    ...
                    <div className="bg-[#1a1a1a]/95 backdrop-blur-md border border-white/10 p-4 rounded-2xl shadow-[0_0_30px_rgba(0,0,0,0.5)] flex flex-col gap-4">
                        <div className="flex justify-between items-start">
                            <div className="flex gap-3">
                                <div className="w-12 h-12 rounded-xl bg-[#EA580C]/20 border border-[#EA580C]/30 flex items-center justify-center shrink-0">
                        ...
                        {isIOS ? (
                            <div className="flex items-center gap-2 text-xs text-gray-300 bg-white/5 p-3 rounded-lg border border-white/5">
                                <span>Tap</span>
                                <Share className="h-4 w-4 text-[#EA580C]" />
                                <span>then select</span>
                                <span className="font-semibold text-white">Add to Home Screen</span>
                                <PlusSquare className="h-4 w-4 text-[#EA580C]" />
                            </div>
                        ) : (
                            <div className="flex items-center gap-2 text-xs text-gray-300 bg-white/5 p-3 rounded-lg border border-white/5">
                                <span>Tap the menu icon and select</span>
