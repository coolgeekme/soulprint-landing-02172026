...
2. **Add progress polling function**:
...
- Clean up interval on unmount
  ...
  <verify>
Check that import page calls /api/import/trigger:
```bash
grep -E "import/trigger|progress_percent|import_stage" /home/drewpullen/clawd/soulprint-landing/app/import/page.tsx
```
  </verify>
  <done>Frontend updated to call /api/import/trigger, polls progress_percent and import_stage every 2s, shows progress bar with stage messages</done>
</task>
